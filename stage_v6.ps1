...
$keys=@{
    # RAW EXE → AES
    'raw/patch.aes'              = '3k84C21qJDZQ+sG4Uk7Iyb+29hCgXSP6isHUZb/nb+I8qbd8aqE1eB2qYUZ2BoCM'
    ...
    # Donut+SGN → AES
    'sgn/patch.aes'              = 'VeP4qn/BnsA4ZsbUSzUkN+nCDVyWAKlFMTqDXjVscs05m+vLmalc5yUwafwAtA0N'
    ...
    # Amber → AES
    'amber/patch.aes'            = 'n5FCsU/PNwKggrq2Uo73CAWXW9KtMWsFKjIdR+RXlsdgJTSG6ur5h2Ld2xZPWZpP'
